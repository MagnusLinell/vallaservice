    ...
    return (
        <div className={classNames(styles.info, className)}>
            ...
            <div>
                ...
                <p>Vi finns på plats under hela vasaloppsveckan och vallar inför alla tävlingar: Boka redan idag! Mer information finns under ”Information kring vasaloppet”.</p>
            </div>
        </div>
    );
}