    ...
    return (
        <>
            <div className={styles.contact}>
                ...
                <div>Telefon: <a href="tel:070-23 55 223">070-23 55 223</a></div>
                <div>Mail: <a href="mailto:vallaservice@vallaservice.com">vallaservice@vallaservice.com</a></div>
                <div>Adress: Kråkstigen 78, 19823 Falköping</div>
            </div>
